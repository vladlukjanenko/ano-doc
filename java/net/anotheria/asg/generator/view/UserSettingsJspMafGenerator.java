 ...
 * @author vkazhdan
 */
public class UserSettingsJspMafGenerator extends AbstractJSPGenerator{
	...
	private GeneratedJSPFile generateEditUserSettingsDialog(){
		...
		appendString("<!--  generated by UserSettingsJSPMafGeneratorGenerator.generateEditUserSettingsDialog -->");
