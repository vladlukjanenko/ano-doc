			...
			appendString("<div class= \"scroll_left\">");
				...
				appendString("<form name=\"Search\" action="+quote(SharedAction.SEARCH.getMappingName())+">");
					...
					appendString("<div class=\"in\">");
						...
						appendString("<ul>");
							increaseIdent();	
							appendString("<li><input type=\"radio\" id=\"r1\" name=\"as\"/><label for=\"r1\">Whole CMS</label></li>");
							appendString("<li><input type=\"radio\" id=\"r2\" name=\"as\"/><label for=\"r2\">Curent section</label></li>");
							appendString("<li><input type=\"radio\" id=\"r3\" name=\"as\"/><label for=\"r3\">Curent page</label></li>");
						decreaseIdent();
						appendString("<ul>");
