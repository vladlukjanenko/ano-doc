...
public class IndexPageJspMafGenerator extends AbstractMafJSPGenerator {
	...
	private GeneratedJSPFile generateIndexPage() {
		...
		increaseIdent();
			...
			appendString("<thead>");
			appendString("<tr>");
			appendString("<td colspan=\"5\"><h2>Last changes</h2></td>");
			appendString("</tr>");
			appendString("<tr>");
			appendString("<td>UserName</td>");
			appendString("<td>Document</td>");
			appendString("<td>Time</td>");
			appendString("<td>Action</td>");
			appendString("<td>Link</td>");
			appendString("</tr>");
			appendString("</thead>");
			appendString("<tbody>");
			...
			appendString("<td><bean:write name=\"change\" property=\"documentName\"/></td>");
			appendString("<td><bean:write name=\"change\" property=\"date\"/></td>");
			appendString("<td><bean:write name=\"change\" property=\"action\"/></td>");
			appendString("<td><a href=\"<bean:write name=\"change\" property=\"parentName\"/><bean:write name=\"change\" property=\"documentName\"/>Edit?pId=<bean:write name=\"change\" property=\"id\"/>\">Link</a></td>");
			appendString("</tr>");
